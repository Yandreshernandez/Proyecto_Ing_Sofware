...
Public Class Gestor_Sesion_de_catacion
    ...
    Public Function Buscar_SesionCatacion(CodSesion) As DataTable 'Devuelve el registro seleccionado en el formulario 'Realizar catación'
        Dim Tabla As New DataTable
        Try
            Dim da As New SqlDataAdapter("SELECT codigo FROM SESION_CATADO WHERE codigo = '" & CodSesion & "'", db.Conexion)
            da.Fill(Tabla)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
