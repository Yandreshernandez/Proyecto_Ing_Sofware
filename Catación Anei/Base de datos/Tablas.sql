...
codigo VARCHAR(7) NOT NULL PRIMARY KEY,
fk_codigo_muestra VARCHAR(7) NOT NULL,
nivel_tueste VARCHAR(1) NOT NULL,
puntaje_fragancia_aroma NUMERIC(2,1) NOT NULL,
puntaje_sabor NUMERIC(2,1) NOT NULL,
puntaje_sabor_boca NUMERIC(2,1) NOT NULL,
puntaje_balance NUMERIC(2,1) NOT NULL,
puntaje_general NUMERIC(2,1) NOT NULL,
puntaje_uniformidad NUMERIC(2,0) NOT NULL,
uniformidad1 VARCHAR(9) NOT NULL,
uniformidad2 VARCHAR(9) NOT NULL,
uniformidad3 VARCHAR(9) NOT NULL,
uniformidad4 VARCHAR(9) NOT NULL,
uniformidad5 VARCHAR(9) NOT NULL,
puntaje_taza_limpia NUMERIC(2,0) NOT NULL,
taza_limpia1 VARCHAR(9) NOT NULL,
taza_limpia2 VARCHAR(9) NOT NULL,
taza_limpia3 VARCHAR(9) NOT NULL,
taza_limpia4 VARCHAR(9) NOT NULL,
taza_limpia5 VARCHAR(9) NOT NULL,
numero_defectos NUMERIC(3,0) NOT NULL,
nota VARCHAR(MAX),
...
puntaje_acidez NUMERIC(2,1) NOT NULL,
puntaje_cuerpo NUMERIC(2,1) NOT NULL,
puntaje_dulzor NUMERIC(2,0) NOT NULL,
dulzor1 VARCHAR(9) NOT NULL,
dulzor2 VARCHAR(9) NOT NULL,
dulzor3 VARCHAR(9) NOT NULL,
dulzor4 VARCHAR(9) NOT NULL,
dulzor5 VARCHAR(9) NOT NULL,
...
puntaje_sal_acido NUMERIC(2,1) NOT NULL,
baja_salinidad VARCHAR(1),
alta_acidez VARCHAR(1),
puntaje_amargo_dulce NUMERIC(2,1) NOT NULL,
bajo_amargor VARCHAR(1),
alto_dulzor VARCHAR(1),
puntaje_sensacion_boca NUMERIC(2,1) NOT NULL,
